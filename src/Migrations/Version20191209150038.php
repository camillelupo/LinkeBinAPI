 ...
 */
final class Version20191209150038 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE bin (id UUID NOT NULL, lat geography(POINT, 4326) NOT NULL, lon geography(POINT, 4326) NOT NULL, is_enable BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
